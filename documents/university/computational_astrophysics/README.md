...
featured_note: |
  ...
  profiles, and plots what comes back — first-order Euler against RK2 and
  Lax-Wendroff, the second-order MUSCL scheme with slope limiters, and operator
  splitting for the combined equation.
